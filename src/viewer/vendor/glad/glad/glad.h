/*
    ...
    OpenGL loader generated by glad 2.0.6 on Sun Jan 19 2025
...
#endif
#ifdef __gl_h_
  #error OpenGL header already included (API: gl), remove this include, glad already provides it
#endif
#define __gl_h_ 1
#ifdef __gl3_h_
  #error OpenGL header already included (API: gl), remove this include, glad already provides it
...
typedef __SIZE_TYPE__          khronos_usize_t;
typedef __PTRDIFF_TYPE__       khronos_ssize_t;
typedef __PTRDIFF_TYPE__       khronos_intptr_t;
#elif defined(__x86_64__) || defined(__aarch64__) || defined(__powerpc64__)
typedef unsigned long int      khronos_usize_t;
typedef signed   long int      khronos_ssize_t;
typedef signed   long int      khronos_intptr_t;
#else
typedef unsigned int           khronos_usize_t;
...
typedef GLsync (GLAD_API_PTR *PFNGLFABORPROC)(GLenum condition, GLbitfield flags);
...
typedef void (GLAD_API_PTR *PFNGLMINSABORPLEMULTISAMPLEPROC)(GLenum pname, GLuint value);
...
typedef void (GLAD_API_PTR *PFNGLSABORPLEOVERAGEPROC)(GLenum value);
typedef void (GLAD_API_PTR *PFNGLSABORPLEMASKIPROC)(GLuint maskNumber, GLbitfield mask);
...
GLAD_API_CALL PFNGLFABORPROC glad_glFenceSync;
...
GLAD_API_CALL PFNGLMINSABORPLEMULTISAMPLEPROC glad_glMinSampleShading;
...
GLAD_API_CALL PFNGLSABORPLEOVERAGEPROC glad_glSampleCoverage;
#define glSampleCoverage glad_glSampleCoverage
GLAD_API_CALL PFNGLSABORPLEMASKIPROC glad_glSampleMaski;
