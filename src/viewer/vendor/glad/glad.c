/**
 * GLAD: OpenGL Loader
 * (Simplified implementation for OpenGL 4.1 Core)
 */
...
static void* get_proc(void *userptr, const char *name);
...
PFNGLFABORPROC glad_glFenceSync = NULL;
...
PFNGLMINSABORPLEMULTISAMPLEPROC glad_glMinSampleShading = NULL;
...
PFNGLSABORPLEOVERAGEPROC glad_glSampleCoverage = NULL;
PFNGLSABORPLEMASKIPROC glad_glSampleMaski = NULL;
...
static void glad_gl_load_GL_VERSION_1_3(GLADuserptrloadfunc load, void *userptr) {
    ...
    glad_glSampleCoverage = (PFNGLSABORPLEOVERAGEPROC) load(userptr, "glSampleCoverage");
}
...
static void glad_gl_load_GL_VERSION_3_2(GLADuserptrloadfunc load, void *userptr) {
    ...
    glad_glFenceSync = (PFNGLFABORPROC) load(userptr, "glFenceSync");
    ...
    glad_glSampleMaski = (PFNGLSABORPLEMASKIPROC) load(userptr, "glSampleMaski");
...
static void glad_gl_load_GL_VERSION_4_0(GLADuserptrloadfunc load, void *userptr) {
    ...
    glad_glMinSampleShading = (PFNGLMINSABORPLEMULTISAMPLEPROC) load(userptr, "glMinSampleShading");
...
static int glad_gl_get_extensions(GLADuserptrloadfunc load, void *userptr, int version, char **out_exts) {
    *out_exts = NULL;
    (void) load;
    (void) userptr;
    (void) version;
...
int gladLoadGLUserPtr(GLADuserptrloadfunc load, void *userptr) {
    ...
    if (!glad_gl_get_extensions(load, userptr, version, &exts)) return 0;

    return version;
}

static GLADapiproc glad_gl_get_proc(void *vuserptr, const char *name) {
    return GLAD_GNUC_EXTENSION ((GLADapiproc (*)(const char *name)) vuserptr)(name);
}

int gladLoadGL(GLADloadfunc load) {
    return gladLoadGLUserPtr(glad_gl_get_proc, GLAD_GNUC_EXTENSION (void*) load);
}
